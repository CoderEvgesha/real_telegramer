...
public enum Text {
    ...
    ABOUT_US("В данном разделе вы сможете узнать все о команде НТ, наших проектах и отзывах о них \uD83D\uDCCA"),
    EDUCATION("Узнать всю информацию о курсе по бизнесу в Telegram вы можете на нашем лендинге\uD83D\uDC47"),
    ...
    PROJECTS_BY_KEY("Узнать всю информацию о канале в Telegram под ключ вы можете на нашем лендинге\uD83D\uDC47"),
    ORDER("Выберите предпочтительный способ связи."),
    BOTS("Наши разработчики готовы создать вашего индивидуального автоматизированного помощника. Узнать больше подробностей можно в статье \uD83D\uDC47"),
    TEAM("[Статья](%s) об основателях проекта \"Настоящий Телеграмщик\" \uD83D\uDC68\u200D\uD83D\uDCBB"),
    WRITE_ME("\uD83D\uDD8D Постарайтесь как можно конкретнее описать задачу: проблемы, ожидания, идеи, цели. Если сложно сформировать запрос с нуля, можно воспользоваться инструкцией\uD83D\uDC47"),
    ...
    RECALL_ME("Чтобы мы могли связаться с вами и лично ответить на вопрос, отправьте боту следующую информацию:\n" +
            "\n" +
            "- номер телефона \uD83D\uDCF2\n" +
